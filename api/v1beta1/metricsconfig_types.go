...
type AuthenticationStatus struct {
	...
	// TokenURL is a field of CostManagementMetricsConfig to represent the url used to generate a service account token.
	TokenURL string `json:"token_url,omitempty"`

	// DeprecationNotice is a field of CostManagementMetricsConfig to represent a deprecation notice.
