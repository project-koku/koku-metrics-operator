...
func (in *UploadStatus) DeepCopyInto(out *UploadStatus) {
	*out = *in
	...
	if in.LastUploadTime != nil {
		in, out := &in.LastUploadTime, &out.LastUploadTime
		*out = (*in).DeepCopy()
	}
	if in.LastSuccessfulUploadTime != nil {
		in, out := &in.LastSuccessfulUploadTime, &out.LastSuccessfulUploadTime
		*out = (*in).DeepCopy()
	}
}
