...
test: generate fmt vet manifests
	...
	source ${ENVTEST_ASSETS_DIR}/setup-envtest.sh; fetch_envtest_tools $(ENVTEST_ASSETS_DIR); setup_envtest_env $(ENVTEST_ASSETS_DIR); tree $(ENVTEST_ASSETS_DIR); go test ./... -coverprofile cover.out -covermode=atomic
