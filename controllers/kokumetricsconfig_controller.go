...
var (
	...
	sourceSpec *kokumetricscfgv1alpha2.CloudDotRedHatSourceSpec
)
...
func StringReflectSpec(r *KokuMetricsConfigReconciler, kmCfg *kokumetricscfgv1alpha2.KokuMetricsConfig, specItem *string, statusItem *string, defaultVal string) (string, bool) {
...
func ReflectSpec(r *KokuMetricsConfigReconciler, kmCfg *kokumetricscfgv1alpha2.KokuMetricsConfig) {

	StringReflectSpec(r, kmCfg, &kmCfg.Spec.APIURL, &kmCfg.Status.APIURL, kokumetricscfgv1alpha2.DefaultAPIURL)
	...
	StringReflectSpec(r, kmCfg, &kmCfg.Spec.Upload.IngressAPIPath, &kmCfg.Status.Upload.IngressAPIPath, kokumetricscfgv1alpha2.DefaultIngressPath)
	...
	if !reflect.DeepEqual(kmCfg.Spec.ReportingCycle, kmCfg.Status.ReportingCycle) {
		kmCfg.Status.ReportingCycle = kmCfg.Spec.ReportingCycle
	}

	StringReflectSpec(r, kmCfg, &kmCfg.Spec.Source.SourcesAPIPath, &kmCfg.Status.Source.SourcesAPIPath, kokumetricscfgv1alpha2.DefaultSourcesPath)
	...
	// if !reflect.DeepEqual(kmCfg.Spec.Packaging.PackagingCycle, kmCfg.Status.Packaging.PackagingCycle) {
	// 	kmCfg.Status.Packaging.PackagingCycle = kmCfg.Spec.Packaging.PackagingCycle
	// }

	StringReflectSpec(r, kmCfg, &kmCfg.Spec.PrometheusConfig.SvcAddress, &kmCfg.Status.Prometheus.SvcAddress, kokumetricscfgv1alpha2.DefaultPrometheusSvcAddress)
...
func GetClusterID(r *KokuMetricsConfigReconciler, kmCfg *kokumetricscfgv1alpha2.KokuMetricsConfig) error {
...
func GetAuthSecret(r *KokuMetricsConfigReconciler, kmCfg *kokumetricscfgv1alpha2.KokuMetricsConfig, authConfig *crhchttp.AuthConfig, reqNamespace types.NamespacedName) error {
	ctx := context.Background()
...
func checkCycle(logger logr.Logger, cycle int64, lastExecution metav1.Time, action string) bool {
	...
	log.Info(fmt.Sprintf("not time to execute %s", action))
	return false

}

func setClusterID(r *KokuMetricsConfigReconciler, kmCfg *kokumetricscfgv1alpha2.KokuMetricsConfig) error {
...
func setAuthentication(r *KokuMetricsConfigReconciler, authConfig *crhchttp.AuthConfig, kmCfg *kokumetricscfgv1alpha2.KokuMetricsConfig, reqNamespace types.NamespacedName) error {
	log := r.Log.WithValues("kokumetricsconfig", "setAuthentication")
	if kmCfg.Status.Authentication.AuthType == kokumetricscfgv1alpha2.Token {
...
func setOperatorCommit(r *KokuMetricsConfigReconciler, kmCfg *kokumetricscfgv1alpha2.KokuMetricsConfig) {
...
func checkSource(r *KokuMetricsConfigReconciler, authConfig *crhchttp.AuthConfig, kmCfg *kokumetricscfgv1alpha2.KokuMetricsConfig) {
...
func packageFiles(r *KokuMetricsConfigReconciler, kmCfg *kokumetricscfgv1alpha2.KokuMetricsConfig, dirCfg *dirconfig.DirectoryConfig) {
	log := r.Log.WithValues("kokumetricsconfig", "packageFiles")

	// if its time to package the report files
	if !checkCycle(r.Log, *kmCfg.Status.ReportingCycle, kmCfg.Status.Packaging.LastSuccessfulPackagingTime, "file packaging") {
		return
	}
...
func uploadFiles(r *KokuMetricsConfigReconciler, authConfig *crhchttp.AuthConfig, kmCfg *kokumetricscfgv1alpha2.KokuMetricsConfig, dirCfg *dirconfig.DirectoryConfig) error {
	...
	if !checkCycle(r.Log, *kmCfg.Status.ReportingCycle, kmCfg.Status.Upload.LastSuccessfulUploadTime, "upload") {
		return nil
	}
...
func collectPromStats(r *KokuMetricsConfigReconciler, kmCfg *kokumetricscfgv1alpha2.KokuMetricsConfig, dirCfg *dirconfig.DirectoryConfig) {
...
func configurePVC(r *KokuMetricsConfigReconciler, kmCfg *kokumetricscfgv1alpha2.KokuMetricsConfig) (*ctrl.Result, error) {
	ctx := context.Background()
...
func (r *KokuMetricsConfigReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	kmCfgOriginal := &kokumetricscfgv1alpha2.KokuMetricsConfig{}
...
func (r *KokuMetricsConfigReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&kokumetricscfgv1alpha2.KokuMetricsConfig{}).
		Complete(r)
}
