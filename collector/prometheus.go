...
var (
	promSpec *kokumetricscfgv1alpha2.PrometheusSpec
...
func getPrometheusConfig(kmCfg *kokumetricscfgv1alpha2.PrometheusSpec, inCluster bool) (*PrometheusConfig, error) {
	if !inCluster {
...
func statusHelper(kmCfg *kokumetricscfgv1alpha2.KokuMetricsConfig, status string, err error) {
	switch status {
	case "configuration":
		if err != nil {
...
func (c *PromCollector) GetPromConn(kmCfg *kokumetricscfgv1alpha2.KokuMetricsConfig) error {
