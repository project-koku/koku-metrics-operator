...
var (
	...
	podQueries = &querys{
		query{
			...
			QueryString: "sum(kube_pod_container_resource_limits{resource='cpu'} * on(container, pod, namespace) group_right kube_pod_container_status_ready)  by (pod, namespace, node)",
		...
		query{
			...
			QueryString: "sum(kube_pod_container_resource_limits{resource='memory'} * on(container, pod, namespace) group_right kube_pod_container_status_ready)  by (pod, namespace, node)",
			MetricKey:   staticFields{"pod": "pod", "namespace": "namespace", "node": "node"},
			QueryValue: &saveQueryValue{
		...
		query{
			...
			QueryString: "sum(kube_pod_container_resource_requests{resource='cpu'} * on(container, pod, namespace) group_right kube_pod_container_status_ready)  by (pod, namespace, node)",
			MetricKey:   staticFields{"pod": "pod", "namespace": "namespace", "node": "node"},
			QueryValue: &saveQueryValue{
		...
		query{
			...
			QueryString: "sum(kube_pod_container_resource_requests{resource='memory'} * on(container, pod, namespace) group_right kube_pod_container_status_ready)  by (pod, namespace, node)",
			MetricKey:   staticFields{"pod": "pod", "namespace": "namespace", "node": "node"},
			QueryValue: &saveQueryValue{
