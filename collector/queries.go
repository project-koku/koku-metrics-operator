...
var (
	QueryMap = map[string]string{
		...
		"ros:image_owners":                   "kube_pod_container_info{container!='', container!='POD', pod!='', namespace!='', namespace!~'kube-.*|openshift|openshift-.*'} * on(pod) group_left(owner_kind, owner_name) max by(pod, owner_kind, owner_name) (kube_pod_owner{container!='', container!='POD', pod!='', namespace!='', namespace!~'kube-.*|openshift|openshift-.*'})",
		"ros:image_workloads":                "kube_pod_container_info{container!='', container!='POD', pod!='', namespace!='', namespace!~'kube-.*|openshift|openshift-.*'} * on(pod) group_left(workload, workload_type) max by(pod, workload, workload_type) (namespace_workload_pod:kube_pod_owner:relabel{pod!='', namespace!='', namespace!~'kube-.*|openshift|openshift-.*'})",
