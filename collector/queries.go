...
var (
	QueryMap = map[string]string{
		...
		"ros:image_owners":                   "max_over_time(kube_pod_container_info{container!='', container!='POD', pod!='', namespace!='', namespace='koku-metrics-operator-2'}[15m]) * on(pod) group_left(owner_kind, owner_name) max by(pod, owner_kind, owner_name) (max_over_time(kube_pod_owner{container!='', container!='POD', pod!='', namespace!='', namespace='koku-metrics-operator-2'}[15m]))",
