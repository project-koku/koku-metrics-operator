...
## Configurable parameters:
  ...
  * `prometheus_config`:
    ...
    * `exclude_gpu_namespaces: ["nvidia-gpu-operator"]` -> Namespaces to exclude from GPU metrics reports. Pods in these namespaces will not appear in GPU cost data. The default excludes the NVIDIA GPU operator namespace.
